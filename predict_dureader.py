...
#             continue
        ...
        if example.start_position is None or example.end_position is None:
            tok_start_position = -1
            tok_end_position = -1
        if is_training:
            if example.start_position < len(orig_to_tok_index):
            ...
            if type(tok_start_position) != int:
                tok_start_position = -1
            if type(tok_end_position) != int:
                tok_end_position = -1
        ...
        for (doc_span_index, doc_span) in enumerate(doc_spans):
            ...
            features.append(
                InputFeatures(
                    ...
                    end_position=end_position))
            unique_id += 1
            logger.info('features length: {}'.format(len(features)))
